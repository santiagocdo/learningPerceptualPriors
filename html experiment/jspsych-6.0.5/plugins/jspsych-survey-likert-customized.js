...
jsPsych.plugins['survey-likert'] = (function() {
  ...
  function customizedButtonEnabling(document) { // Customized stuff
    document.querySelectorAll('.jspsych-survey-likert jspsych-btn').disabled = false
    // document.querySelectorAll('.jspsych-survey-likert-next button').disabled = false
  }
  ...
  plugin.trial = function(display_element, trial) {
    ...
    display_element.querySelector('#jspsych-survey-likert-form').addEventListener('submit', function(e){
      ...
      setTimeout(customizedButtonEnabling, 2000, document) // Customized stuff
