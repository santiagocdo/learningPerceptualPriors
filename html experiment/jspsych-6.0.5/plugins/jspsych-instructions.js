...
// Dawei Bai's modifications: 
// 1. "previous" button isn't shown
// 2. button_delay: enable buttons only after a delay
// 3. default "continue" button reads "next"
      ...
      if (trial.show_clickable_nav) {
        ...
        if (current_page != 0 && trial.allow_backward) {
          display_element.querySelector('#jspsych-instructions-back').addEventListener('click', btnListener);
		    ...
		    setTimeout(function(){ document.getElementById('jspsych-instructions-next').disabled=false}, trial.button_delay); //this is added
